"""ktaxiv01_24572 URL Configuration
...
admin.site.site_header = "KTAXIv01"
admin.site.site_title = "KTAXIv01 Admin Portal"
admin.site.index_title = "KTAXIv01 Admin"

# swagger
api_info = openapi.Info(
    title="KTAXIv01 API",
    default_version="v1",
    description="API documentation for KTAXIv01 App",
)
